...
class UserAdapter(var activity: Activity,var users:MutableList<User>):RecyclerView.Adapter<UserAdapter.UserViewHolder>() {
    ...
    override fun onBindViewHolder(holder: UserViewHolder, position: Int) {
        ...
        if (users[position].status!!){
            holder.status.setBackgroundResource(R.drawable.online)
        }else{
