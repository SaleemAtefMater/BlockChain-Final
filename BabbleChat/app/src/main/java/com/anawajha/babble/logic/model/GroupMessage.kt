...
data class GroupMessage(var source_id:String, var source_name:String, var message:String? , var groupId:String /*, var imageMessage:ByteArray?*/) {
...
//        message.put(Constants.IMAGE_MESSAGE,this.imageMessage)
        message.put("groupId",this.groupId)
        return message
    }// encode
    ...
    companion object{
        fun decode(obj:JSONObject):GroupMessage{
            return GroupMessage(obj.getString(Constants.SOURCE_ID), obj.getString(Constants.SOURCE_NAME),
                obj.getString(Constants.MESSAGE),obj.getString("groupId")/*,obj.get(Constants.IMAGE_MESSAGE) as ByteArray*/)
        }// decode
